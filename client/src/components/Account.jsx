...
const Account = () => {
    ...
    <div className=" bg-blue-900 flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">



    {!currentAccount ?

      (<button type="button" onClick={connectWallet} className="flex flex-row justify-center itmes-center my-5 bg-[#ffffff] p-3 rounded-full cursor-pointer hover:bg-[#99ff33]">
      ...
      : (
        ...
        <>
          <div className="p-4 justify-end items-start flex-col rounded-xl h-80 sm:w-72 w-full my-6  ">
